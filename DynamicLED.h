...
public:
	...
	#define ID_LED_YELLOW	2003
	#define ID_LED_BLUE		2004

	// The constants needed to define the shape of the LED
	#define ID_SHAPE_ROUND	3001
	#define ID_SHAPE_SQUARE	3002
	#define ID_SHAPE_UP			3003
	#define ID_SHAPE_DOWN		3004
	#define ID_SHAPE_LEFT		3005
	#define ID_SHAPE_RIGHT	3006
...
public:
	...
	void SetLED(CWnd *pWnd,UINT nIDColor, UINT nIDShape, int nTimerInterval,BOOL fl_on=true);
